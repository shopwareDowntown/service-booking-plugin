...
module.exports = (() => {
    ...
    const swagServiceBooking = require('service-booking/core').default;
    ...
    Shopware.Application.getContainer('init').httpClient.interceptors.response.handlers = [];

    swagServiceBooking.install(Shopware);
})();
